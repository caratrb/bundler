...
RSpec.describe Carat::YAMLSerializer do
  subject(:serializer) { Carat::YAMLSerializer }
  ...
  describe "#load" do
    ...
    it "handles colon in key/value" do
      yaml = strip_whitespace <<-YAML
        CARAT_MIRROR__HTTPS://RUBYGEMS__ORG/: http://rubygems-mirror.org
      YAML

      expect(serializer.load(yaml)).to eq("CARAT_MIRROR__HTTPS://RUBYGEMS__ORG/" => "http://rubygems-mirror.org")
    end
