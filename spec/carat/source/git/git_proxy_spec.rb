...
RSpec.describe Carat::Source::Git::GitProxy do
  let(:uri) { "https://github.com/caratrb/carat.git" }
  subject { described_class.new(Pathname("path"), uri, "HEAD") }

  context "with configured credentials" do
    it "adds username and password to URI" do
      Carat.settings.temporary(uri => "u:p")
      expect(subject).to receive(:git_retry).with(match("https://u:p@github.com/caratrb/carat.git"))
      subject.checkout
    end

    it "adds username and password to URI for host" do
      Carat.settings.temporary("github.com" => "u:p")
      expect(subject).to receive(:git_retry).with(match("https://u:p@github.com/caratrb/carat.git"))
      subject.checkout
    end

    it "does not add username and password to mismatched URI" do
      Carat.settings.temporary("https://u:p@github.com/caratrb/carat-mismatch.git" => "u:p")
    ...
    it "keeps original userinfo" do
      Carat.settings.temporary("github.com" => "u:p")
      original = "https://orig:info@github.com/caratrb/carat.git"
