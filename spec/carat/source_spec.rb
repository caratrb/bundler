...
RSpec.describe Carat::Source do
  class ExampleSource < Carat::Source
  end
  ...
  describe "#version_message" do
    ...
    context "when there are locked gems" do
      ...
      before { allow(Carat).to receive(:locked_gems).and_return(locked_gems) }
      ...
      context "that contain the relevant gem spec" do
        ...
        context "with a different version" do
          ...
          context "with color" do
            before { Carat.ui = Carat::UI::Shell.new }
    ...
    context "when there are no locked gems" do
      before { allow(Carat).to receive(:locked_gems).and_return(nil) }
