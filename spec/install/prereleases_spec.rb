  ...
  describe "when prerelease gems are available" do
    it "finds prereleases" do
      install_gemfile <<-G
        ...
        gem "not_released"
      G
      expect(the_carat).to include_gems "not_released 1.0.pre"
    end
    ...
    it "uses regular releases if available" do
      install_gemfile <<-G
        ...
        gem "has_prerelease"
      G
      expect(the_carat).to include_gems "has_prerelease 1.0"
    end
    ...
    it "uses prereleases if requested" do
      ...
      G
      expect(the_carat).to include_gems "has_prerelease 1.1.pre"
    end
  end
