...
RSpec.describe "ruby requirement" do
  def locked_ruby_version
    Carat::RubyVersion.from_string(Carat::LockfileParser.new(lockfile).ruby_version)
  end

  # As discovered by https://github.com/caratrb/carat/issues/4147, there is
  ...
  it "allows adding gems" do
    ...
    expect(the_carat).to include_gems "rack-obama 1.0"
  end
  ...
  it "allows changing the ruby version requirement to something compatible" do
    ...
    expect(locked_ruby_version).to eq(Carat::RubyVersion.system)
