...
describe "bundle open" do
  ...
  it "opens the gem with CARAT_EDITOR as highest priority" do
    bundle "open rails", :env => {"EDITOR" => "echo editor", "VISUAL" => "echo visual", "CARAT_EDITOR" => "echo carat_editor"}
  ...
  it "does not blow up if the gem to open does not have a Gemfile" do
    ...
    bundle "open foo", :env => {"EDITOR" => "echo editor", "VISUAL" => "", "CARAT_EDITOR" => ""}
  ...
  it "opens the gem with short words" do
    bundle "open rec" , :env => {"EDITOR" => "echo editor", "VISUAL" => "echo visual", "CARAT_EDITOR" => "echo carat_editor"}
