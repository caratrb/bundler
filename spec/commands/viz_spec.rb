...
RSpec.describe "carat viz", :ruby => "1.9.3", :carat => "< 2", :if => Carat.which("dot") do
  ...
  it "graphs gems that are prereleases" do
    ...
    carat! "viz", :format => :debug, :version => true
