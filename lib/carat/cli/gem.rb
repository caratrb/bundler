...
module Carat
  ...
  class CLI::Gem
    ...
    def run
      ...
      git_installed = Carat.git_present?
      ...
      templates.merge!("gitignore.tt" => ".gitignore") if Carat.git_present?
      ...
      if ask_and_set(:mit, "Do you want to license your code permissively under the MIT license?",
        ...
        config[:mit] = true
        Carat.ui.info "MIT License enabled in config"
      ...
      if ask_and_set(:coc, "Do you want to include a code of conduct in gems you generate?",
        ...
        config[:coc] = true
        Carat.ui.info "Code of conduct enabled in config"
  ...
  private
    ...
    def ask_and_set(key, header, message)
      choice = options[key]
      choice = Carat.settings["gem.#{key}"] if choice.nil?
    ...
    def ensure_safe_gem_name(name, constant_array)
      ...
      existing_constant = constant_array.inject(Object) do |c, s|
        defined = begin
          ...
          Carat.ui.error "Invalid gem name #{name} -- `#{constant_name}` is an invalid constant name"
          exit 1
        end
      ...
      Carat.ui.error "Invalid gem name #{name} constant #{constant_name} is already in use. Please choose another gem name."
      exit 1
    end
