  ...
  class CLI::Inject
    ...
    def run
      ...
      gems.each_slice(4) do |gem_name, gem_version, gem_group, gem_source|
        ...
        deps << Carat::Dependency.new(gem_name, gem_version, "group" => gem_group, "source" => gem_source)
      end
      ...
      if added.any?
        ...
        Carat.ui.confirm(added.map do |d|
          name = "'#{d.name}'"
        ...
        Carat.ui.confirm "All gems were already present in the Gemfile"
      end
    end
