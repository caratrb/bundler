...
module Carat::Molinillo
  class Resolver
    ...
    class Resolution
      ...
      require 'carat/vendor/molinillo/lib/molinillo/delegates/resolution_state'
      require 'carat/vendor/molinillo/lib/molinillo/delegates/specification_provider'

      include Carat::Molinillo::Delegates::ResolutionState
      include Carat::Molinillo::Delegates::SpecificationProvider
