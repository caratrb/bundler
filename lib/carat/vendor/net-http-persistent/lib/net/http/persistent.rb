...
require 'carat/vendor/net-http-persistent/lib/net/http/faster'
require 'uri'
...
#
# Carat::Persistent::Net::HTTP::Persistent maintains persistent connections across all the
# servers you wish to talk to.  For each host:port you communicate with a
# single persistent connection is created.
#
# Multiple Carat::Persistent::Net::HTTP::Persistent objects will share the same set of
# connections.
#
# For each thread you start a new connection will be created.  A
# Carat::Persistent::Net::HTTP::Persistent connection will not be shared across threads.
#
# You can shut down the HTTP connections when done by calling #shutdown.  You
# should name your Carat::Persistent::Net::HTTP::Persistent object if you intend to call this
# method.
#
# Example:
#
#   require 'carat/vendor/net-http-persistent/lib/net/http/persistent'
#
#   uri = URI 'http://example.com/awesome/web/service'
#
#   http = Carat::Persistent::Net::HTTP::Persistent.new 'my_app_name'
#
#   # perform a GET
...
#   begin
#     response = http.request post_uri, post
#   rescue Carat::Persistent::Net::HTTP::Persistent::Error
#
...
#
# If you are done using the Carat::Persistent::Net::HTTP::Persistent instance you may shut down
...
class Carat::Persistent::Net::HTTP::Persistent
  ...
  ##
  # The version of Carat::Persistent::Net::HTTP::Persistent you are using
  ...
  ##
  # Error class for errors raised by Carat::Persistent::Net::HTTP::Persistent.  Various
  ...
  ##
  # Creates a new Carat::Persistent::Net::HTTP::Persistent.
  #
  ...
  def connection_for uri
    ...
    if use_ssl then
      raise Carat::Persistent::Net::HTTP::Persistent::Error, 'OpenSSL is not available' unless
        HAVE_OPENSSL
  ...
  def http_class # :nodoc:
    if RUBY_VERSION > '2.0' then
      ...
      Carat::Persistent::Net::HTTP::Persistent::SSLReuse
    end
  end
  ...
  #
  # If you've used Carat::Persistent::Net::HTTP::Persistent across multiple threads you should
...
require 'carat/vendor/net-http-persistent/lib/net/http/persistent/ssl_reuse'
