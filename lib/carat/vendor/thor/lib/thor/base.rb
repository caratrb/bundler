...
class Carat::Thor
  ...
  module Base
    ...
    def initialize(args = [], local_options = {}, config = {})
      ...
      opts = Carat::Thor::Options.new(parse_options, hash_options, stop_on_unknown, disable_required_check)
    ...
    protected
      ...
      def is_thor_reserved_word?(word, type) #:nodoc:
        ...
        raise "#{word.inspect} is a Carat::Thor reserved word and cannot be defined as #{type}"
      end
      ...
      def build_option(name, options, scope) #:nodoc:
        scope[name] = Carat::Thor::Option.new(name, options.merge(:check_default_type => check_default_type?))
      end
