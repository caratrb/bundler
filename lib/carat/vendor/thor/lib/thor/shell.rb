...
class Bundler::Thor
  ...
  module Shell
    ...
    autoload :Basic, "carat/vendor/thor/lib/thor/shell/basic"
    autoload :Color, "carat/vendor/thor/lib/thor/shell/color"
    autoload :HTML,  "carat/vendor/thor/lib/thor/shell/html"
