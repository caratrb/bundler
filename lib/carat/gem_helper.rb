...
module Carat
  ...
  protected
    ...
    def rubygem_push(path)
      ...
      unless allowed_push_host || Carat.user_home.join(".gem/credentials").file?
        raise "Your rubygems.org credentials aren't set. Run `gem push` to set them."
      end
      sh(gem_command)
      Carat.ui.confirm "Pushed #{name} #{version} to #{gem_push_host}"
    end
    ...
    def gem_key
      Carat.settings["gem.push_key"].to_s.downcase if Carat.settings["gem.push_key"]
    end
