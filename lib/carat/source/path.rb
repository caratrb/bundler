  ...
  class Source
    class Path < Source
      ...
      def initialize(options)
        ...
        @root_path = options["root_path"] || Carat.root
    ...
    private
      ...
      def lockfile_path
        ...
        expand(original_path).relative_path_from(Carat.root)
      end
      ...
      def has_app_cache?
        SharedHelpers.in_carat? && app_cache_path.exist?
      end

      def load_gemspec(file)
        return unless spec = Carat.load_gemspec(file)
