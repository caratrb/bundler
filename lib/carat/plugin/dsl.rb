...
module Carat
  module Plugin
    ...
    class DSL < Carat::Dsl
      ...
      # by name carat-source-<type> to list of plugins to be installed.
      #
      ...
      def method_missing(name, *args)
        raise PluginGemfileError, "Undefined local variable or method `#{name}' for Gemfile" unless Carat::Dsl.method_defined? name
      end
      ...
      def source(source, *args, &blk)
        ...
        plugin_name = "carat-source-#{options["type"]}"
