    ...
    class API
      ...
      module Source
        ...
        def post_install(spec, disable_exts = false)
          ...
          installer = Carat::Source::Path::Installer.new(spec, opts)
        ...
        #
        # @return [Carat::Index] index containing the specs
        def specs
          files = fetch_gemspec_files

          Carat::Index.build do |index|
            files.each do |file|
              next unless spec = Carat.load_gemspec(file)
